...
* Consider exclusively using a 3G / 4G / 5G mobile internet connection.

{% hint style="warning" %}
IT staff occasionally set up an internet firewall for small business to prevent accessing harmful content. Ensure that menupas.com is white-listed on your firewall to avoid connection issues to our servers.
{% endhint %}
